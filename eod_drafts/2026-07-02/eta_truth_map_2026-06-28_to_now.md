...
_Wygenerowano: 2026-07-02T13:56:28.538872+02:00  ·  narzędzie: tools/eta_truth_map.py (read-only)_
...
- Zleceń w oknie (sla, delivered): **1037**
- Czasówki pominięte: 56
- Bez rekordu shadow (utracone okno / brak decyzji): 16
- Realny kurier poza pulą kandydatów (niedopasowane): 407
- **Dopasowane do realnego kuriera: 558**
  - z nogą ODBIORU (pickup_err): 553
  - z nogą DOSTAWY (deliv_err): 553

## NOGA: ODBIÓR (dojazd-po-odbiór)
**Ogółem: n=553  mediana=-3.6 min  p10=-18.6  p90=+7.4**  (− = optymizm silnika)
...
| srednio (4-6) | 169 | -3.6 | -17.6 | +6.4 |

### Wg pory dnia (bucket)
| segment | n | mediana (min, − = optymizm) | p10 | p90 |
|---|---|---|---|---|
| offpeak | 45 | -3.5 | -17.1 | +9.4 |
| peak | 300 | -2.7 | -16.4 | +7.1 |
...
| Pizza Dealer | 7 | ZA MAŁO DANYCH | — | — |


## NOGA: DOSTAWA (od odbioru do klienta)
**Ogółem: n=553  mediana=+1.3 min  p10=-16.6  p90=+17.2**  (− = optymizm silnika)
...
| srednio (4-6) | 169 | +0.3 | -17.8 | +11.2 |

### Wg pory dnia (bucket)
| segment | n | mediana (min, − = optymizm) | p10 | p90 |
|---|---|---|---|---|
| offpeak | 45 | -1.5 | -20.8 | +13.9 |
| peak | 300 | +1.3 | -16.2 | +13.8 |
