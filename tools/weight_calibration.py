...
# źródło). Indeks shrec jest last-wins per oid → chronologiczny porządek kanonu
# = najświeższy wygrywa (0 kolizji między plikami w oknie → identycznie). Filtry
# konsumenta NIETKNIĘTE, metryki BEZ ZMIAN.
try:
