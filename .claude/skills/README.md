...
| **ziomek-cto** | cykl sesji CTO: brief stanu, mapa kompletności zmiany (ETAP 3 #0), bramka DoD na diffie, szablon handoffu | `driver.py brief/scope/dod/handoff` | `selftest.sh` (17/17) |
