...
> LIVE `2b5a616`, NATURALNY AUDYT 0/3 FLAGGED; KOREKTA DANYCH DRY-RUN
> PASS 13/13, APPLY HOLD DO OSOBNEGO ACK; OBSERWACJA DO 15.07
...
| M-P1-01 | Mailek: jeden kanon personalizacji Validator/Q1/audyt | 13/18 dzisiejszych auto-maili CEIDG mialo falszywy jedyny powod `notes_overlap_low=1`: audyt duplikowal tokenizacje i twardy prog 2, gdy dwa upstream gate'y kanonicznie wymagaja dla CEIDG 1. | Wspolny helper utrzymuje `CEIDG=1`, inne/brak roli=2, zero-overlap nadal fail; read-only replay daje 5/13 legacy kontra 18/0 candidate. | S + 2 dni obserwacji | LIVE code `2b5a616`, docs `5bb102a`, rollback tag na `e961291`; naturalny run candidates3/flagged0. Osobny instrument `2afb76a`: dry-run PASS 13 target / 13 eligible / 0 hold, DB+WAL bez zmiany, 235/235. APPLY danych nadal HOLD do osobnego ACK, backupu `.backup` i transakcji warunkowej; obserwacja do 15.07 |
