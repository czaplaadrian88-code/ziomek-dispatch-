...
| D-P1-01 | Dareczek: brama pilota sprzedażowo-obsługowego | ETAP 0 i lokalny ETAP 1 są w commicie panelu `3328b50`: fail-closed eligibility, ledger zgód, suppression, exact ACK, immutable offers, syntetyczny DRAFT_ONLY i 79 testów. Pilot nadal nie ma wspólnej suppression/hot-kill z Mailekiem, realnego bezpiecznego transportu, RBAC/MFA, revocation ofert, trwałego audytu denied ani potwierdzonej umowy epaka/DPO. | Po osobnym sprincie wszystkie sendery użyją jednej bramy permission/suppression/kill, realne oferty będą wersjonowane i odwoływalne, a pilot przejdzie PostgreSQL/concurrency/security/legal gate bez automatycznej wysyłki. | XL; `model_tier=sol`, `effort=ultra` | LOCAL ETAP 1 ACCEPT; ETAP 2/LIVE HOLD. Wymaga DPO/legal, umowy epaka, zatwierdzonego API/exportu, infrastruktury pocztowej i osobnych ACK na migrację, deploy/restart oraz każdą wysyłkę |
