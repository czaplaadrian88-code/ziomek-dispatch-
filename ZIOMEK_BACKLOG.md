...
| Z-P1-07 | Rejestr i cykl zycia flag | `flags.json` ma 278 kluczy; istnieja trzy swiaty flag. Nowa flaga pin-memory ominela dokumentacje i izolacje testow. | Kazda flaga dostanie wlasciciela, faze, default, date review i warunek usuniecia; dryft zatrzyma CI. | L | Bez masowego flipa |
...
| Z-P2-07 | Hermetyczne testy i fixture danych | Czesc testow czyta zywe logi, aliasy i exclusion state hosta. | Testy beda dzialac identycznie na czystym CI i produkcyjnym hoście; realne fixture beda wersjonowane i anonimizowane. | L | Powiazane z Z-P0-03 |
