...
Wave 3 RUNNING: D1 (`ultra`, tmux65, merge po at-214), DR1A (`high`, tmux66,
fake/code-prep) i OPS0 (`high`, tmux67, read-only runtime evidence). Wszystkie
sa na osobnych worktree z base `e0fd1e4`, bez operacji live. H1 nadal czeka na
R0+D1+B-01/B-02.
