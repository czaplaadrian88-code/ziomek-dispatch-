...
Kolejne trzy: D1 (`ultra`, merge po at-214), DR1A (`high`, fake/code-prep) i
OPS0 (`high`, read-only runtime evidence). H1 nadal czeka na R0+D1+B-01/B-02.
