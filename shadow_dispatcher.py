...
def _serialize_candidate(c) -> dict:
    ...
    out = {
        ...
        "bundle_deliv_coloc_km": m.get("bundle_deliv_coloc_km"),
        "bundle_deliv_coloc_active": m.get("bundle_deliv_coloc_active"),
        "bonus_deliv_coloc": m.get("bonus_deliv_coloc"),
    ...
    out = {
        ...
        "best": None if best is None else {
            ...
            **_promised_pickup_fields(best_m, result),
            ...
            "bundle_deliv_coloc_km": best_m.get("bundle_deliv_coloc_km"),
            "bundle_deliv_coloc_active": best_m.get("bundle_deliv_coloc_active"),
            "bonus_deliv_coloc": best_m.get("bonus_deliv_coloc"),
